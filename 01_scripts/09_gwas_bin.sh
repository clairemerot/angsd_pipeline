...
angsd -P $NB_CPU -nQueueSize 50 -ybin $PHENO -doAsso 2 -GL 2 -doPost 1 -doMajorMinor 1 -doMaf 1 \
-remove_bads 1 -minMapQ 30 -minQ 20 -minInd $MIN_IND -minMaf $MIN_MAF \
-b 02_info/bam.filelist -out 09_gwas/all_maf"$MIN_MAF"_pctind"$PERCENT_IND".binary.gwas
